...
export const AppDataSource = new DataSource({
  ...
  logging: false,
  entities: [Restaurant, Sessions, Restaurant_Ingredients, Subscriptions_Licenses, Restaurant_Order , Plans, Restaurant_Recipe, Recipe_Ingredients, Restaurant_Subscriptions, Restaurant_Tables, Admins, Order_Recipes, Delivery_Order_Details, Local_Order_Details],
  migrations: [],
  subscribers: [],
});
